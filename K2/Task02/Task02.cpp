...
int largestSumFromSubmatrices(int matrix[MATRIX_MAX_SIZE][MATRIX_MAX_SIZE], size_t submatrixRows, size_t submatrixCols, size_t& submatrixBegRowInd, size_t& submatrixBegColInd) {
...
int main() {
	...
	cout << largestSumFromSubmatrices(matrix, Q, P, submatrixRowInd, submatrixColInd) << ' ';
